...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.expandableListViewController = ExpandableListViewController()
    ...
    func configureExpandableViews() {
        ...
        let dataView2 = configureExpandableDataView(with: DataContainer(content:[
            ...
            DataItem(title: "Item 32", content: "Content 32"),
        ...
        DispatchQueue.global(qos: .background).asyncAfter(deadline: .now() + 1.5) {
            DispatchQueue.main.async {
                let dataView3 = self.configureExpandableDataView(with: DataContainer(content:[
                    DataItem(title: "Item 13", content: "Content 13"),
                    ...
                    DataItem(title: "Item 63", content: "Content 63")
                ]))
                dataView3.toggleShowMode()
                ...
                let dataView4 = self.configureExpandableDataView(with: DataContainer(content:[
                    ...
                    DataItem(title: "Item 34", content: "Content 34"),
                ...
                dataView4.toggleShowMode()
                self.expandableListViewController?.insert(expandableContent: [dataView3, dataView4], at: 0)
            }
        }

        expandableListViewController.insert(expandableContent: [dataView1, dataView2]) //append(expandableContent: dataView1, dataView2)
    }
